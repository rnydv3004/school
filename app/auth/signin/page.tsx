...
const SignIn: React.FC = () => {
  return (
    <div className="rounded-sm border h-screen overflow-y-auto border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
          <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
            ...
            <form>
              ...
              <div className="mb-5">
                <Link href={"/dashboard"}><p className="w-full text-center cursor-pointer rounded-lg border border-primary bg-primary p-4 text-white transition hover:bg-opacity-90"
                >Sign In</p></Link>
              </div>
