...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-white dark:bg-black duration-300 ease-linear shadow-1 shadow-bodydark lg:static lg:translate-x-0 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"
        }`}
    >
      {/* <!-- SIDEBAR HEADER --> */}
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        {/* <!-- Sidebar Menu --> */}
        <nav className="mt-3 py-2 px-4 lg:mt-2 lg:px-6">
          {/* <!-- Menu Group --> */}
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <Link
                  href="/"
                  className={`group relative flex items-center gap-2.5 rounded-lg py-2 px-4 font-medium text-graydark dark:text-whiten duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 hover:text-white ${(pathname === "/" ||
              ...
              <li>
                <Link
                  href="/calendar"
                  className={`group relative flex items-center gap-2.5 rounded-lg py-2 px-4 font-medium text-graydark dark:text-whiten duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 hover:text-white ${pathname.includes("calendar") &&
                    "bg-primary text-whiten"
                    }`}
                >
                  <svg
              ...
              <li>
                <Link
                  href="/profile"
                  className={`group relative flex items-center gap-2.5 rounded-lg py-2 px-4 font-medium text-graydark dark:text-whiten duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 hover:text-white ${pathname.includes("profile") && "bg-primary  text-whiten"
                    }`}
                >
                  <svg
                    className="fill-current"
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <Link
                        href="#"
                        className={`group relative flex items-center gap-2.5 rounded-lg py-2 px-4 font-medium text-graydark dark:text-whiten duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 hover:text-white ${(pathname === "/forms" ||
              ...
              <li>
                <Link
                  href="/tables"
                  className={`group relative flex items-center gap-2.5 rounded-lg py-2 px-4 font-medium text-graydark dark:text-whiten duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 hover:text-white ${pathname.includes("tables") && "bg-primary text-whiten"
                    }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <Link
                  href="/settings"
                  className={`group relative flex items-center gap-2.5 rounded-lg py-2 px-4 font-medium text-graydark dark:text-whiten duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 hover:text-white ${pathname.includes("settings") &&
                    "bg-primary text-whiten"
                    }`}
                >
                  <svg
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <Link
                  href="/chart"
                  className={`group relative flex items-center gap-2.5 rounded-lg py-2 px-4 font-medium text-graydark dark:text-whiten duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 hover:text-white ${pathname.includes("chart") &&
                    "bg-primary text-whiten"
                    }`}
                >
                  <svg
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <Link
                        href="#"
                        className={`group relative flex items-center gap-2.5 rounded-lg py-2 px-4 font-medium text-graydark dark:text-whiten duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 hover:text-white ${(pathname === "/ui" || pathname.includes("ui")) &&
                          "bg-primary"
                          }`}
                        onClick={(e) => {
                          e.preventDefault();
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/ui/alerts"
                              className={`group relative flex items-center gap-2.5 rounded-lg py-2 px-4 font-medium text-graydark dark:text-whiten duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 hover:text-white ${(pathname === "/ui/alerts") &&
                                "bg-primary text-whitten"
                                }`}
                            >
                              Alerts
                            </Link>
                          ...
                          <li>
                            <Link
                              href="/ui/buttons"
                              className={`group relative flex items-center gap-2.5 rounded-lg py-2 px-4 font-medium text-graydark dark:text-whiten duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 hover:text-white ${(pathname === "/ui/buttons") &&
                                "bg-primary text-whitten"
                                }`}
                            >
                              Buttons
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <Link
                        href="#"
                        className={`group relative flex items-center gap-2.5 rounded-lg py-2 px-4 font-medium text-graydark dark:text-whiten duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 hover:text-white ${(pathname === "/auth") &&
                          "bg-primary text-whitten"
                          }`}
                        onClick={(e) => {
                          e.preventDefault();
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/auth/signin"
                              className={`group relative flex items-center gap-2.5 rounded-lg py-2 px-4 font-medium text-graydark dark:text-whiten duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 hover:text-white ${(pathname === "/auth/signin") &&
                                "bg-primary text-whitten"
                                }`}
                            >
                              Sign In
                          ...
                          <li>
                            <Link
                              href="/auth/signup"
                              className={`group relative flex items-center gap-2.5 rounded-lg py-2 px-4 font-medium text-graydark dark:text-whiten duration-300 ease-in-out hover:bg-primary dark:hover:bg-meta-4 hover:text-white ${(pathname === "/auth/signup") &&
                                "bg-primary text-whitten"
                                }`}
                            >
                              Sign Up
